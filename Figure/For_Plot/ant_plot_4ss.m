function ax=ant_plot_4ss(x,y,ax,A,ca,colorset,colabel,seri,axble,colorbarback,colorbaruni)
...
if isnan(colorbarback)
    ...
    ax2 = axes('position',[pos2(1)+0.03 pos2(2)+0.01 0.01 0.383989501312336/3.5],'XTick',[],'YTick',[],'Box','on');
