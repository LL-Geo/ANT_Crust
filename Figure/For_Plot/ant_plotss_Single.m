function ant_plotss_Single(ax,A,ca,colorset,colabel,seri)
...
x=-3140000:20000:3140000;
y=-3140000:20000:3140000;
...
pos2 = plotboxpos(gca);
pos3= [pos2(1),pos2(2)+pos2(4)-0.07/3,0.07,0.07/2-0.001];
a=colorbar('west','Position',...
    [pos2(1)+0.05 pos2(2)+0.02 0.015 0.383989501312336/1.1],...
    'AxisLocation','in');
if isnan(colorset)
else
